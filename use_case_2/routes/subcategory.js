// Εξάγεται το μονοπάτι από το URL
const path = window.location.pathname;

// Διαχωρίζεται το μονοπάτι χρησιμοποιώντας το "/" ως διαχωριστικό
...
window.addEventListener("load", function () {
    ...
    fetch(`https://wiki-ads.onrender.com/ads?subcategory=${subId}`)
      ...
      .then(ads => {
        ...
        // Χρησιμοποιει  το Handlebars για να συνθέσει το HTML με βάση το template
